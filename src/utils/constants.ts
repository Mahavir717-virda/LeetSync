...
export enum MessageType {
  ...
  // Historical Importer Message Types
  CHECK_IMPORT_CAPABILITY = 'CHECK_IMPORT_CAPABILITY',
  START_PROFILE_DISCOVERY = 'START_PROFILE_DISCOVERY',
  START_SUBMISSION_DISCOVERY = 'START_SUBMISSION_DISCOVERY',
  START_HISTORICAL_IMPORT = 'START_HISTORICAL_IMPORT',
  PAUSE_IMPORT = 'PAUSE_IMPORT',
  CANCEL_IMPORT = 'CANCEL_IMPORT',
  GET_IMPORT_SESSION = 'GET_IMPORT_SESSION',
}
